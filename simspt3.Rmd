...
knitr::opts_chunk$set(echo = TRUE, 
                      fig.path='output/figures/simspt3/simspt2_fig', 
                      #fig.height = 10,
...
sigpal <- as.character(factor(paste(adonisP, centroidP), labels=rcbalpha(0.8, 4, 'RdYlBu')[c(2,1,4,3)] ))
...
* light red: adonis and centroid Not significant (GOOD)
```{r, echo=FALSE, fig.width=7, fig.height=4.5, dependson=c('coldistcache', 'adoniscache')}
par(mfrow=c(2,3))
