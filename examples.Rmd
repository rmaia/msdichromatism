...
```{r mimic_triplot, fig.width=8, fig.height=8}
...
```{r mimic_deltaplot, fig.width=8, fig.height=8}
...
Reflectance data from various body regions (H = head, L = left arm, R = right arm, P = prothorax, W = wing, A = abdomen) of 27 female mantids _Pseudomantis albofimbriata_ and 50 background samples (Lomandra longifolia, which they pretty much exclusively hang on).
...
```{r mantid_tcs, fig.width=8, fig.height=8}
