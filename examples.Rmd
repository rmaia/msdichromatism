...
```{r mimic_hexplot, fig.width=6, fig.height=6}
...
On everything, combined. i.e. are these three groups different? Not really required in this situation since we have _a priori_ planned tests.
```{r}
