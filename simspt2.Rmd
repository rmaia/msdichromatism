...
```{r, echo=FALSE, fig.height=12, fig.width=9, dependson=c('coldistcache', 'adoniscache', 'lmercache', 'vovcache', 'centroidcache')}
...
```{r, echo=FALSE, fig.height=12, fig.width=9, dependson=c('coldistcache.t1', 'adoniscache.t1', 'lmercache.t1', 'vovcache.t1', 'centroidcache.t1')}
...
```{r, echo=FALSE, fig.height=12, fig.width=9, dependson=c('coldistcache.t2', 'adoniscache.t2', 'lmercache.t2', 'vovcache.t2','centroidcache.t2')}
...
```{r, echo=FALSE, fig.height=12, fig.width=9, dependson=c('coldistcache.t3', 'adoniscache.t3', 'lmercache.t3', 'vovcache.t3','centroidcache.t3')}
