...
```{r, echo=FALSE, cache=TRUE, fig.height=12, fig.width=9, dependson=c('coldistcache', 'adoniscache', 'lmercache', 'vovcache', 'centroidcache')}
...
h1 <- hist(interdist, breaks=seq(0, ceiling(max(c(interdist,intradistM,centdist))),by=0.5), plot=F)
h2 <- hist(intradistM, breaks=seq(0, ceiling(max(c(interdist,intradistM,centdist))),by=0.5), plot=F)
h3 <- hist(centdist, breaks=seq(0, ceiling(max(c(interdist,intradistM,centdist))),by=0.5), plot=F)

plot(c(0,h1$breaks), c(0,h1$counts,0), type='s',col=rgb(1,0,0,0.6), lwd=3,
     ylab='Frequency', xlab='mean distance (JND)',
     ylim=range(c(h1$counts,h2$counts,h3$counts))* c(0,1.1))
lines(c(0,h2$breaks), c(0,h2$counts,0), col=rgb(0,0,1,0.6), type='s', lwd=3)
lines(c(0,h3$breaks), c(0,h3$counts,0), col=rgb(0,1,0,0.6), type='s', lwd=3)

legend('topright', fill=c(rgb(1,0,0,0.6),rgb(0,0,1,0.6), rgb(0,1,0,0.6)), 
       c('inter','intra', 'centroid'))
...
```{r, echo=FALSE, cache=TRUE, fig.height=12, fig.width=9, dependson=c('coldistcache.t1', 'adoniscache.t1', 'lmercache.t1', 'vovcache.t1', 'centroidcache.t1')}
...
h1 <- hist(interdist.t1, breaks=seq(0, ceiling(max(c(interdist.t1,intradistM.t1,centdist.t1))),by=0.5), plot=F)
h2 <- hist(intradistM.t1, breaks=seq(0, ceiling(max(c(interdist.t1,intradistM.t1,centdist.t1))),by=0.5), plot=F)
h3 <- hist(centdist.t1, breaks=seq(0, ceiling(max(c(interdist.t1,intradistM.t1,centdist.t1))),by=0.5), plot=F)
...
rm(adonissim.t1,  simulatedata.t1, simulatecoldist.t1, interdist.t1, intradistM.t1, adonisP.t1, adonisR2.t1, vovlpbo.t1)
```
...
```{r, echo=FALSE, cache=TRUE, fig.height=12, fig.width=9, dependson=c('coldistcache.t2', 'adoniscache.t2', 'lmercache.t2', 'vovcache.t2','centroidcache.t2')}
...
h1 <- hist(interdist.t2, breaks=seq(0, ceiling(max(c(interdist.t2,intradistM.t2,centdist.t2))),by=0.5), plot=F)
h2 <- hist(intradistM.t2, breaks=seq(0, ceiling(max(c(interdist.t2,intradistM.t2,centdist.t2))),by=0.5), plot=F)
h3 <- hist(centdist.t2, breaks=seq(0, ceiling(max(c(interdist.t2,intradistM.t2,centdist.t2))),by=0.5), plot=F)
...
rm(adonissim.t2, simulatedata.t2, simulatecoldist.t2, interdist.t2, intradistM.t2, adonisP.t2, adonisR2.t2, vovlpbo.t2)
```
...
```{r, echo=FALSE, cache=TRUE, fig.height=12, fig.width=9, dependson=c('coldistcache.t3', 'adoniscache.t3', 'lmercache.t3', 'vovcache.t3','centroidcache.t3')}
...
h1 <- hist(interdist.t3, breaks=seq(0, ceiling(max(c(interdist.t3,intradistM.t3,centdist.t3))),by=0.5), plot=F)
h2 <- hist(intradistM.t3, breaks=seq(0, ceiling(max(c(interdist.t3,intradistM.t3,centdist.t3))),by=0.5), plot=F)
h3 <- hist(centdist.t3, breaks=seq(0, ceiling(max(c(interdist.t3,intradistM.t3,centdist.t3))),by=0.5), plot=F)
...
rm(adonissim.t3, simulatedata.t3, simulatecoldist.t3, interdist.t3, intradistM.t3, adonisP.t3, adonisR2.t3, vovlpbo.t3)
```
