...
hist(interdist.t1, xlab='mean distance (JND)', breaks=seq(0,100,by=1), col=rgb(1,0,0,0.6), main='', xlim=range(c(interdist.t1,intradistM.t1))* c(0,1.1), ylim=c(0,300))
hist(intradistM.t1, col=rgb(0,0,1,0.6), breaks=seq(0,100,by=1), add=TRUE)
hist(centdist.t1, col=rgb(0,1,0,0.6), breaks=seq(0,100,by=1), add=TRUE)
legend('topright', fill=c('red','blue', 'green'), c('intra','inter', 'centroid'))
