...
```{r, echo=FALSE, fig.height=12, dependson=c('coldistcache', 'adoniscache', 'lmercache', 'vovcache', 'centroidcache')}
...
legend('topright', fill=c('red','blue', 'green'), c('intra','inter', 'centroid'))
...
```{r, echo=FALSE, fig.height=12, dependson=c('coldistcache.t1', 'adoniscache.t1', 'lmercache.t1', 'vovcache.t1', 'centroidcache.t1')}
...
```{r, echo=FALSE, fig.height=12, dependson=c('coldistcache.t2', 'adoniscache.t2', 'lmercache.t2', 'vovcache.t2','centroidcache.t2')}
