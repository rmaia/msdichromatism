...
hist(interdist, xlab='mean distance (JND)', breaks=seq(0,50,by=0.4), col=rgb(1,0,0,0.6), main='', xlim=range(c(interdist,intradistM))* c(0,1.1))
...
hist(interdist.t1, xlab='mean distance (JND)', breaks=seq(0,100,by=4), col=rgb(1,0,0,0.6), main='', xlim=range(c(interdist.t1,intradistM.t1))* c(0,1.1))
hist(intradistM.t1, col=rgb(0,0,1,0.6), breaks=seq(0,100,by=4), add=TRUE)
legend('topright', fill=c('red','blue'), c('intra','inter'))
...
hist(interdist.t2, xlab='mean distance (JND)', breaks=seq(0,50,by=0.4), col=rgb(1,0,0,0.6), main='', xlim=range(c(interdist.t2,intradistM.t2))* c(0,1.1))
