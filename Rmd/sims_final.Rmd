...
knitr::opts_chunk$set(echo = TRUE, 
                      fig.path='../output/figures/finalsims/fs_', 
                      #fig.height = 10,
                      cache.path = '../output/cache/finalsims/fs_')
...
plot(adonisR2~interdist, ylab='Rsquared from PERMANOVA (%)', xlab='mean between-group distance (JND)', pch=19, col=sigpal)

plot(adonisR2~intradist, ylab='Rsquared from PERMANOVA (%)', xlab='mean within-group  distance (JND)', pch=19, col=sigpal)
...
plot(adonisR2~centdist, ylab='Rsquared from PERMANOVA (%)', xlab='centroid distance (JND)', pch=19, col=sigpal)
