...
points(rbind(colMeans(gA), colMeans(gB)), pch=4, lwd=3, col=c('#4575b4', '#d73027'), cex=1.5)
...
mpga <- movePoints(matrix(colMeans(gA), nrow=1), matrix(colMeans(gB), nrow=1), 0.03)
mpgb <- movePoints(matrix(colMeans(gB), nrow=1), matrix(colMeans(gA), nrow=1), 0.03)
...
abline(v=as.numeric(dist(rbind(colMeans(gA), colMeans(gB)))), lty=1, lwd=2)
