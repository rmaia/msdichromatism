...
To make it clearer how this applies to the comparison between groups in color space, let's show this in two dimensions: ![](../output/figures/meandiff_unnamed-chunk-6-1.png)
