...
legend('topleft', col=powerpal[c(9,1)], pt.bg=powerpal[c(9,1)], pch=21, lty=1, 
...
box()
legend('topleft', legend=c('significant only in distance PERMANOVA','significant only in cartesian MANOVA'), pch=15, cex=0.9, pt.cex=2, col=powerpal[c(9,1)], bty='n')

plot(tapply(disagreement.n10, effsims, mean)*100~unique(effsims), type='b', pch=21, col=grey(0.8), bg=grey(0.8), ylim=c(0,40), xlim=c(0,3.8), ylab='Disagreement between approaches (%)', xlab='Simulated effect size (Mahalanobis distance)', cex=2, lwd=4, xaxt='n')
axis(1, at=c(0,1,2,3))
