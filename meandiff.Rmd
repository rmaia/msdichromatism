...
In fact, the mean of Euclidean distances - mean(sqrt((xi - xj)^2)) - is related to the mean of the square root of the squared differences - mean(sqrt((mean(x) - xi)^2)) -, and the (mean) squared difference is a measure of spread, like the standard deviation. _It therefore will increase as a function of the **mean variance of the groups**, not the **mean distance between the groups**_.(I'm not sure this is a valid relationship or how it'd scale, but I think I'm on to something.)
