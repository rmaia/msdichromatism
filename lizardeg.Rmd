...
knitr::opts_chunk$set(echo = TRUE, 
                      fig.path='output/lizardeg/lizardeg_fig')
```

# Example using reflectance data from several body regions of male and female _Ctenophorus ornatus_ (Whiting et al. 2015, Biol J Linn Soc)
